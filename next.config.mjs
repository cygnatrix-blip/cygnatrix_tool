...
const securityHeaders = [
  ...
  // camera=(self): the Document Scanner uses getUserMedia for its live preview. Still
  // denied to any cross-origin iframe. microphone/geolocation stay fully disabled.
